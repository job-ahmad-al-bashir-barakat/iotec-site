            ...
            <div class="section">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>This license is a legal agreement between you and IOTec LLC for the use of IOTec
                            Software (the “Software”). By downloading any IOTec files, add-ons, or resources,
                            you agree to be bound by the terms and conditions of this license. IOTec LLC reserves
                        ...
                        <p>One license grants the right to use the Software on one site and unlimited development
                            ...
                            license.</p>
                        <h2>Restrictions</h2>
                        <p>Unless you have been granted prior, written consent from IOTec LLC, you may not:</p>
                        <ul>
                        ...
                        <p>You may alter, modify, or extend the Software for your own use, or commission a
                            ...
                            transfer the modified or derivative version without prior written consent from IOTec
                            LLC. Components from the Software may not be extracted and used in other programs
                            without prior written consent from IOTec LLC.</p>
                        <h2>Technical Support</h2>
                        <p>IOTec LLC does not provide direct phone support at this time. No representations or
                        ...
                        <h2>Refunds</h2>
                        <p>IOTec LLC offers limited refunds on software within 15 days of purchase. Contact
                            info@iotec.me for assistance.</p>
                        <h2>Indemnity</h2>
                        <p>You agree to indemnify and hold harmless IOTec LLC for any third-party claims, actions
                        ...
                        <p>THE SOFTWARE IS PROVIDED “AS IS”, WITHOUT WARRANTY OF ANY KIND, EXPRESSED OR IMPLIED,
                            ...
                            MERCHANTABILITY, OR FITNESS FOR A PARTICULAR PURPOSE. FURTHER, IOTec LLC DOES NOT
