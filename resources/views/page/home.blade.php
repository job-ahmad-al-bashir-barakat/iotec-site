							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											IOTec is a top Business and Technology Solutions team in Syria that
                                                excels in developing custom enterprise applications, mobile solutions
                                                and state of the art IT solutions.
										</h4>
										<br />
										<div class="buttons">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											We continuously develop our own skill set to remain at the forefront of
                                                industry standards, in order to provide relevant, pertinent, and
                                                trend-setting apps for you and your customers.
										</h4>
										<br />
										<div class="buttons">
											<a href="#contactus" class="btn btn-danger btn-lg">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											We deliver quality web design at affordable costs; with solid experience
                                                in simple and complex web apps. We develop customized Websites, Blogs,
                                                CSM Systems, and more.
										</h4>
										<br />
										<div class="buttons">
											<a href="#contactus" class="btn btn-danger btn-lg">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											We build the online identity for your successful company and broadcast
							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											Our designs are meant to inspire action, no matter what is the project,
							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											Our animation team offers affordable architecture and product
                                                visualization solutions that helps convert client’s ideas into reality
                                                by delivering the best quality visuals under tight deadlines.
										</h4>
										<br />
										<div class="buttons">
											<a href="#contactus" class="btn btn-danger btn-lg">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-8 ml-auto mr-auto text-center">
										...
										<h4>
											At IOTec, we help you assess, design, and implement the physical
                                                infrastructure needed to provide a network that is flexible to the
                                                changing demands of your organization.
										</h4>
										<br />
										<div class="buttons">
											<a href="#contactus" class="btn btn-danger btn-lg">
				...
				<div class="row" style="margin-bottom: 70px;">
					<div class="col-md-8 ml-auto mr-auto text-center">
						...
						<h5 class="description">
							list of our services that we can gladly provide to users around the
                                clock, so take a quick look to get to know us and what we able to do.
						</h5>
					</div>
				</div>
				<div class="row">
								...
								<div class="col-md-7">
									<div class="card-body">
										...
										<p class="card-description">
											Software Engineer, dedicated to Full Stack Web Development.
										</p>
									</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 ml-auto mr-auto text-center">
							...
							<h5 class="description">
								Read our most recent articles in programming and networks tech
                                    feed and be ready to know new idea every day to expand your knowlage.
							</h5>
						</div>
					</div>
					<div class="row">
		...
		<div class="cd-section" id="partners">
			<div class="clients-1 pt-0">
				<div class="container">
					<div class="row">
						<div class="col-md-8 ml-auto mr-auto text-center">
							<h2 class="title">Trusted by Our Customers</h2>
							<h5 class="description">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						...
						<h5 class="description">
							Describe your product and our team will make it for you and get it
                                ready for use.
						</h5>
						<div class="info info-horizontal">
							<div class="icon icon-primary">
