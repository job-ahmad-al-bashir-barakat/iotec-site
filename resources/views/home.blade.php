...
<head>
    ...
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('assets/img/favicon/apple-icon-180x180.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('assets/img/favicon/apple-icon-180x180.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('assets/img/favicon/apple-icon-180x180.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/img/favicon/apple-icon-180x180.png') }}">
    <link rel="icon" type="image/png" sizes="192x192"  href="{{ asset('assets/img/favicon/favicon-16x16.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/img/favicon/favicon-16x16.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('assets/img/favicon/favicon-16x16.png') }}">
    ...
    <!-- CSS Custom -->
    <link href="{{ asset('assets/demo/app.css') }}" rel="stylesheet" />
                    ...
                    <div class="col-md-10 ml-auto mr-auto">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary btn-round">
                                <i class="material-icons">turned_in_not</i> See More
                            </button>
                        </div>
                    </div>
                </div>
...
<footer class="footer footer-white footer-big">
    <div class="container">
        ...
        <div class="copyright pull-center">
            ...
            </script> IOTec Team All Rights Reserved.
        </div>
    </div>
</footer>
<!--   Core JS Files   -->
...
<!-- Js With initialisations For App -->
<script src="{{ asset('assets/js/app.js') }}" type="text/javascript"></script>
<!-- Control Center for Material Kit: parallax effects, scripts for the example pages etc -->
<script src="{{ asset('assets/js/material-kit.js?v=2.1.0') }}" type="text/javascript"></script>
<script>
