...
Nova.booting(function (Vue, router) {
    Vue.component('index-autocomplete', __webpack_require__(3));
    Vue.component('detail-autocomplete', __webpack_require__(6));
    Vue.component('form-autocomplete', __webpack_require__(9));
});
