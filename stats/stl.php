...
# CONFIGURABLE VARIABLES
    ...
    # Timezone
    date_default_timezone_set('Asia/Damascus'); # Comment this out if you wish to use your server's time. Valid timezones are listed at http://www.php.net/manual/en/timezones.php
